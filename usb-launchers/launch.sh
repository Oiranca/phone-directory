...
BIN="$USB_ROOT/linux-unpacked/hospiagenda"
APPIMAGE="$USB_ROOT/HospiAgenda.AppImage"
...
echo "ERROR: Cannot find linux-unpacked/hospiagenda or HospiAgenda.AppImage at $USB_ROOT" >&2
exit 1
