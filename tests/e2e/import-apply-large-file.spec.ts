...
/**
 * Mandatory end-to-end gate for the "works in preview,
 ...
 * (horizontally-overflowing) preview table. The old
 ...
 * the fix it passes.
 */
test.describe("bulk ODS import survives a same-document navigation between preview and confirm", () => {
