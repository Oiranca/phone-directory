...
describe("SettingsPage", () => {
  ...
  it("Browse backup dir: successful pick populates the input and marks form dirty", async () => {
    ...
    fireEvent.click(screen.getByRole("button", { name: "Seleccionar carpeta de copia de seguridad" }));
  ...
  it("Browse buttons are disabled while save is in progress", async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getByRole("button", { name: "Seleccionar carpeta de copia de seguridad" })).toBeDisabled();
    });
  });
  ...
  it("Browse buttons are re-enabled after path reset returns", async () => {
    ...
    await waitFor(() => {
      ...
      expect(screen.getByRole("button", { name: "Seleccionar carpeta de copia de seguridad" })).not.toBeDisabled();
    });
  });
