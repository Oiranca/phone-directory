    ...
    <span className={["inline-flex flex-col gap-1", className].filter(Boolean).join(" ")}>
      ...
      <span className="flex flex-wrap items-center gap-2">
        <button
          ...
          className="rounded px-1.5 py-0.5 text-xs font-medium text-slate-500 underline hover:text-slate-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-scs-blue/40"
        >
