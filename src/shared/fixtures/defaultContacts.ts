import type { DirectoryDataset } from "../types/contact.js";

export const defaultContacts: DirectoryDataset = {
  version: "1.0.0",
  exportedAt: "2026-04-13T00:00:00Z",
  metadata: {
    recordCount: 2,
    generatedFrom: "example",
    generatedBy: "src/shared/fixtures/defaultContacts.ts",
    editorName: "System",
    typeCounts: {
      service: 1,
      "external-center": 1
  ...
  records: [
    ...
    },
    {
      ...
      displayName: "Centro de Salud Demo - Información",
      organization: {
